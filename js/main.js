...
// Function to display all events (for events.html page)
                ...
                <div class="card h-100 event-card" data-id="${event.id}">
                    ...
                    <div class="card-footer bg-transparent">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="event.html?id=${event.id}" class="btn btn-sm btn-primary">Details</a>
                        </div>
                    </div>
                </div>
            </div>
...
// Function to setup event filters on events.html page
