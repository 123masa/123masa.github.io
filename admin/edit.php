...
if ( isset($_POST['title']) && isset($_POST['description']) 
 ...
 $id=$_POST['id'];
    $sql = "UPDATE evente SET title = :title, 
            description = :description, category = :category , location = :location, event_date = :event_date, image = :image
            WHERE id = :id"; 
...
$stmt = $pdo->prepare("SELECT * FROM evente where id = :xyz"); 
...
<p>description: 
<input type="text" name="description" value="<?php echo $description; ?>"></p> 
<p>category: 
<input type="text" name="category" value="<?php echo $category ;?>"></p> 
 <p>location: 
<input type="text" name="location" value="<?php echo $location; ?>"></p> 
<p>event_date: 
<input type="date" name="event_date" value="<?php echo $event_date; ?>"></p> 
<p>image: 
<input type="text" name="image" value="<?php echo $image; ?>"></p>
<p>id: 
<input type="text" name="id" value="<?php echo $id; ?>"></p>
<p><input type="submit" value="Update"/> 
<a href="lang.php">Cancel</a></p> 
</form>   
